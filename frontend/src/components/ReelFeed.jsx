              ...
              <div className="reel-actions">
                <div className="reel-action-group">
                  <button
                    onClick={() => {
                      if (!onLike) return;
                      // call and catch to avoid uncaught promise rejections
                      Promise.resolve(onLike(item)).catch(err => {
                        console.error('Like action failed', err);
                        // graceful fallback: if 401, redirect to login
                ...
                <div className="reel-action-group">
                  <button
                    ...
                    onClick={() => {
                      if (!onSave) return;
                      Promise.resolve(onSave(item)).catch(err => {
